    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            @if (auth()->user()->role->name == 'user')
                ...
                <li class="sidebar-item has-sub {{ Request::is('student-registrations*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-card-checklist"></i>
                        <span>Registrasi Data Siswa</span>
                    </a>

                    <ul class="submenu">
                        <li class="submenu-item {{ Request::routeIs('student-registrations.index') ? 'active' : '' }}">
                            <a href="{{ route('student-registrations.index') }}" class="submenu-link">Lihat</a>
                        </li>
                    </ul>
                </li>
            ...
            @if (auth()->user()->role->name == 'admin')
                ...
                <li class="sidebar-item has-sub {{ Request::is('manage-student-registrations*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-card-checklist"></i>
                        <span>Registrasi Data Siswa</span>
                    </a>
                    ...
                    <ul class="submenu">
                        <li
                            class="submenu-item {{ Request::routeIs('manage-student-registrations.index') ? 'active' : '' }}">
                            <a href="{{ route('manage-student-registrations.index') }}" class="submenu-link">Lihat</a>
                        </li>
                    </ul>
                </li>
